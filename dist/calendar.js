(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        factory(global.jqueryPlugincreator, global.isFunction, global.template, global.each);
        global.calendar = mod.exports;
    }
})(this, function (_jqueryPlugincreator, _isFunction, _template, _each) {
    "use strict";

    var _jqueryPlugincreator2 = _interopRequireDefault(_jqueryPlugincreator);
    ...
    var defaults = {
        ...
        onBeforeEventsLoad: function onBeforeEventsLoad(next) {
            // Inside this function 'this' is the calendar instance
            next();
        },
        ...
        onAfterModalShown: function onAfterModalShown(events) {
            // Inside this function 'this' is the calendar instance
        },
        onAfterModalHidden: function onAfterModalHidden(events) {
            // Inside this function 'this' is the calendar instance
        },
        // -------------------------------------------------------------
    ...
    var members = {
        ...
        _calculate_hour_minutes: function _calculate_hour_minutes(data) {
            var self = this;
        ...
        _hour_min: function _hour_min(hour) {
            var time_start = this.options.time_start.split(":");
            var time_split = parseInt(this.options.time_split);
            var in_hour = 60 / time_split;
            return hour == 0 ? in_hour - parseInt(time_start[1]) / time_split : in_hour;
        },
        _hour: function _hour(hour, part) {
            var time_start = this.options.time_start.split(":");
            var time_split = parseInt(this.options.time_split);
        ...
        _getHoliday: function _getHoliday(date) {
            var result = false;
        ...
        _getHolidayName: function _getHolidayName(date) {
            var holiday = this._getHoliday(date);
            return holiday === false ? "" : holiday;
        },
        _getDayClass: function _getDayClass(class_group, date) {
            var self = this;
            var addClass = function addClass(which, to) {
                var cls;
        ...
        view: function view(_view) {
            if (_view) {
                if (!this.options.views[_view].enable) {
                    return;
                }
                this.options.view = _view;
            }
        ...
        navigate: function navigate(where, next) {
        ...
        _init_position: function _init_position() {
            var year, month, day;
        ...
        _templatePath: function _templatePath(name) {
        ...
        _loadTemplate: function _loadTemplate(name) {
            ...
            $.ajax({
                ...
                self.options.templates[name] = (0, _template2.default)(html, {
                    imports: {
                        each: _each2.default
                    }
                });
        ...
        _update_day: function _update_day() {
            this.context.find('.cal-day-panel').height(this.context.find('.cal-day-panel-hour').height());
        },
        _update_week: function _update_week() {},
        _update_year: function _update_year() {
            this._update_month_year();
        },
        _update_month: function _update_month() {
            this._update_month_year();
            ...
            self.context.find('.cal-month-box .cal-before-eventlist').on('mouseenter', function () {
        ...
        _update_month_year: function _update_month_year() {
            ...
            self.context.find('.cal-month-day, .cal-year-box .cal-cell').on('mouseenter', function () {
        ...
        getEventsBetween: function getEventsBetween(start, end) {
            var events = [];
